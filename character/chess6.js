function chess6(x, y) {//红王
    ...
    skill1.innerHTML = '选择最多5个目标<img height="25px" width="25px" src="./img/choose.png" id="input6_1_1" onclick="input(1,id,7)"><img height="25px" width="25px" src="./img/choose.png" id="input6_1_2" onclick="input(1,id,7)"><img height="25px" width="25px" src="./img/choose.png" id="input6_1_3" onclick="input(1,id,7)"><img height="25px" width="25px" src="./img/choose.png" id="input6_1_4" onclick="input(1,id,7)"><img height="25px" width="25px" src="./img/choose.png" id="input6_1_5" onclick="input(1,id,7)">拉动2格<button style="position: absolute;right: 0px;bottom: 0px;height: 50px;width:50px;" onclick="document.getElementById(selectid).skill1_launch()"></button>';
    ...
    skill3.innerHTML = '选择一个目标<img height="25px" width="25px" src="./img/choose.png" id="input6_3_1" onclick="input(1,id,1)">造成1点伤害并将其推动2格。若推动过程中或结束后目标碰到阻挡物则再造成一点伤害；否则技能冷却减一<button style="position: absolute;right: 0px;bottom: 0px;height: 50px;width:50px;" onclick="document.getElementById(selectid).skill3_launch()"></button>';
