function model(x, y) {//名称
    ...
    chess.movement = 5;
    chess.reflect = 5;
    skill1.innerHTML = '<img height="25px" width="25px" id="input0_1_1" onclick="input1(id,1)"><button style="position: absolute;right: 0px;bottom: 0px;height: 25px;width:25px;" onclick="document.getElementById(selectid).skill1_launch()"></button>';
    skill2.innerHTML = '<img height="25px" width="25px" id="input0_2_1" onclick="input1(id,1)"><button style="position: absolute;right: 0px;bottom: 0px;height: 25px;width:25px;" onclick="document.getElementById(selectid).skill2_launch()"></button>';
    skill3.innerHTML = '<img height="25px" width="25px" id="input0_3_1" onclick="input1(id,1)"><button style="position: absolute;right: 0px;bottom: 0px;height: 25px;width:25px;" onclick="document.getElementById(selectid).skill3_launch()"></button>';
