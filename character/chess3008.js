function chess3008(x, y) {//远古遗迹
    ...
    //以下需改动
    chess.fixedid = 3008;//1~1000人物1001~2000召唤物2001~3000地块
    chess.img = "./img/chess3008.png";
    chess.name = "远古遗迹";
    chess.max_health = 150;//1~30 20
    chess.health = 150;
    chess.max_movement = 0;//1~20 5
    chess.movement = 0;
    chess.reflect = -1;//1~20 5   -1不可行动
    skill1.innerHTML = '<img height="25px" width="25px" src="./img/chooseA.png" id="input0_1_1" onclick="input(1,id,1)"><button style="position: absolute;right: 0px;bottom: 0px;height: 50px;width:50px;" onclick="document.getElementById(selectid).skill1_launch()"></button>';
    ...
    chess.class = 3;//0地块,1人物,2召唤物3障碍物
    chess.style.zIndex = 100;//地块0~100,人物105,动画粒子等120+
