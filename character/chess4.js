...
function chess4(x, y) {//狂刀
    ...
    skill1.innerHTML = '选择一个目标<img height="25px" width="25px" src="./img/chooseA.png" id="input4_1_1" onclick="input(1,id,16)">若之间无障碍且移动足够，消耗对应移动冲刺至目标前，造成3点伤害，并击退1格<button style="position: absolute;right: 0px;bottom: 0px;height: 50px;width:50px;" onclick="document.getElementById(selectid).skill1_launch()"></button>';
