function chess5(x, y) {//无人飞只因操作员
    ...
    chess.movement = 4;
    chess.reflect = 4;
    skill1.innerHTML = '选择位置<img height="25px" width="25px" src="./img/choose.png" src="./img/choose.png" id="input5_1_1" onclick="input(2,id,2)">生成一个战斗无人机<button style="position: absolute;right: 0px;bottom: 0px;height: 50px;width:50px;" onclick="document.getElementById(selectid).skill1_launch()"></button>';
    skill2.innerHTML = '选择位置<img height="25px" width="25px" src="./img/choose.png" id="input5_2_1" onclick="input(2,id,2)">生成一个救治无人机<button style="position: absolute;right: 0px;bottom: 0px;height: 50px;width:50px;" onclick="document.getElementById(selectid).skill2_launch()"></button>';
    skill3.innerHTML = '选择最多五个目标<img height="25px" width="25px" src="./img/choose.png" id="input5_3_1" onclick="input(1,id,12)"><img height="25px" width="25px" src="./img/choose.png" id="input5_3_2" onclick="input(1,id,12)"><img height="25px" width="25px" src="./img/choose.png" id="input5_3_3" onclick="input(1,id,12)"><img height="25px" width="25px" src="./img/choose.png" id="input5_3_4" onclick="input(1,id,12)"><img height="25px" width="25px" src="./img/choose.png" id="input5_3_5" onclick="input(1,id,12)">使其中的无人机进入暴走状态，持续两回合。两回合后对所有无人机造成100点伤害<button style="position: absolute;right: 0px;bottom: 0px;height: 50px;width:50px;" onclick="document.getElementById(selectid).skill3_launch()"></button>';
