function chess9(x, y) {//定神游
    ...
    skill2.innerHTML = '选择一个目标<img height="16px" width="16px" id="input9_2_1" onclick="input(1,id,3)">造成1一点伤害并施加神游印记。（神游状态下发动 传送至前方第三格并对周围8格造成1点伤害）<button style="position: absolute;right: 0px;bottom: 0px;height: 50px;width:50px;" onclick="document.getElementById(selectid).skill2_launch()"></button>';
